...
import heroImage4 from "../assets/images/chico-churrasco-hero.png"
    ...
    return (
        <Section className="relative min-h-screen overflow-hidden flex items-center">
            ...
            <img
                ...
                className="absolute inset-0 h-full w-full object-cover object-[75%_center] lg:object-[100%_center]"
            />
